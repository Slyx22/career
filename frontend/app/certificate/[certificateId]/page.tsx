        ...
        <section className="mx-auto max-w-2xl px-6 py-16">
          ...
          >
            <div className="border border-line px-8 py-10">
              <p className="font-body text-sm tracking-normal text-slate-600">
              ...
              <div className="mt-10 space-y-1 font-body text-xs text-slate-600">
              ...
              <p className="mt-8 font-body text-[11px] italic text-slate-600">
