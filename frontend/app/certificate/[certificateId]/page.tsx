        ...
        <section className="mx-auto max-w-2xl px-6 py-16">
          ...
          >
            <div className="border border-line px-8 py-10">
              <p className="font-body text-sm tracking-normal text-slate-300">
                Career Readiness Certificate
              </p>
              <h1 className="mt-6 font-display text-3xl text-slate-100">
                {cert.first_name?.toUpperCase()} {cert.surname?.toUpperCase()}
              </h1>
              <p className="mt-3 font-body text-lg text-slate-300">
              ...
              <div className="mt-10 space-y-1 font-body text-xs text-slate-300">
              ...
              <p className="mt-8 font-body text-[11px] italic text-slate-300">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4 print:hidden">
            ...
            <a
              ...
              className="focus-ring rounded border border-line px-6 py-3 font-body text-sm text-slate-100 hover:border-ink"
            >
